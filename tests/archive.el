(defun block-concat (strings &optional align text-align)
...
(defun block-stack (strings &optional align text-align)
...
(defun block-bgcolor-change-function (orig-fun &rest args)
