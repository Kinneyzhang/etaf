;;; etaf-css-parse.el --- CSS value parsing -*- lexical-binding: t; -*-

;; Copyright (C) 2024 ETAF Contributors

;; Author: ETAF Contributors
;; Keywords: css, parsing
;; Version: 1.0.0
...
;; CSS 值解析模块
;;
;; 本模块提供 CSS 值解析功能，用于将 CSS 长度值转换为像素或行数。
;; 所有函数使用 `etaf-css-parse-' 前缀。
;;
;; 单位说明：
...
;;
;; 公共接口：
;; - `etaf-css-parse-length' - 解析 CSS 长度值（px, %, em, lh, cw）
;; - `etaf-css-parse-height' - 解析 CSS 高度值（行数单位）
;; - `etaf-css-parse-style-value' - 从计算样式中获取属性值
;; - `etaf-css-parse-flex-number' - 解析 flex 数值属性
;;
;; 常量：
;; - `etaf-css-parse-pixels-per-line' - 像素到行数的转换系数
...
(provide 'etaf-css-parse)
;;; etaf-css-parse.el ends here
